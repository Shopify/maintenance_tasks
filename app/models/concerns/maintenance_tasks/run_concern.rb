...
module MaintenanceTasks
  # Concern that holds the core behavior for Run models. This concern can be
  # included in any class that inherits from ActiveRecord::Base (or a subclass),
  # allowing different Run models to connect to different databases while sharing
  # the same behavior.
  #
  # @api private
  module RunConcern
